...
if __name__ == '__main__':
    ...
    # TRx_strategy = 'flex-rate'   # fixed-rate, flex-rate, shannon
    # network.set_transceiver_for_all_nodes(TRx_strategy)
    ...
    # Initialize lists to store latencies and SNRs
    # latencies = []
    # R_b_lat = []
    # R_b_snr = []
    # snrs = []
            ...
            for i in range(T_tot_connection_req):
                ...
                #    print(i, path_choice, best_path, connection.snr, 'R_b = ', R_b_gbps, 'Gbps')
                    ...
                    for line_label in network.get_lines_from_path(best_path):
                        ...
                        print(f"Optimal Power: {optimal_power * 1e-2} Watts")
                        print(f"GSNR : {GSNR_db} dB")
