...
if __name__ == '__main__':
    ...
    TRx_strategy = ['flex-rate']  # 'fixed-rate'
    T_tot_connection_req = 300
   ...
   # random.seed(1)
    ...
    def update_matrix(req_matrices):
        global TRx_strategy_indx, path_choice, rej_reas
...
def update(frame):
    ...
    update_matrix(req_matrices)  # Call the function to update the matrix
